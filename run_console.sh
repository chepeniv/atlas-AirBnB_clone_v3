...
HBNB_ENV=dev HBNB_MYSQL_USER=hbnb_$HBNB_ENV HBNB_MYSQL_PWD=hbnb_$HBNB_ENV\_pwd HBNB_MYSQL_HOST=localhost HBNB_MYSQL_DB=hbnb_$HBNB_ENV\_db HBNB_TYPE_STORAGE=db ./console.py 2> /dev/null
